<?php
ob_start();
define('API_KEY','5272969805:AAFDP5_H1O7Bf6sO0fVeyGh4zccTH-K2rx4');
$admin = "861676483"; //admin id
$kanalimz ="@hackerdunyosi"; //kanal useri
$botim = "zzzmoneybot";
   function del($nomi){
...
💬 Xizmatdan foydalanish bo'yicha - adminga yozing: [@admin](https://t.me/hackerdunyosi)",
'reply_markup'=>$key,
'parse_mode'=>'markdown',
...
$ss=substr($ex[1],8,8);
  file_put_contents("$cid.t","🔵 Status - ✅ \n\n 🆔 Tolov id: $t \n\n 👤 Qabul qiluvchini raqami: \n\n ☎️$bb $gg $ss \n\n 💰 Tolov summasi: $ex[2] sum");
    bot('sendmessage',[
        'chat_id'=>$cid,
        'text'=>"✅To'lov qabul qilindi! Endi kuting. To'lov 24 soat ichida amalga oshiriladi. ADMIN: @Karooluz/ ✅Оплата принимается! Просто подождите. Оплата будет произведена в течение 24 часов. АДМИН: @hackerdunyosi"
        ]);
...
$azo=file_put_contents("coin/$cid.txt","");
 ...
 💲 Sizning hozirgi balansingiz: $ball🎊 so`m",
        ...
        bot('sendMessage',[
        'chat_id'=>$cid,
        'text'=>"🔄Kanallar topilmadi. Iltimos keyinroq urunib ko'ring Hurmat Bilan @Karooluz.",
        'reply_markup'=>$key,
        ]);
      }
    }
...
📋 Чтобы начать продвижение Вашего канала, необходимо напишите админ: @Karooluz",
...
💬Что-бы вопсользоваться услугой - напишите [@admin](https://t.me/hackerdunyosi ) ",
'reply_markup'=>$menu,
'parse_mode'=>'markdown',
'disable_web_page_preview'=>true
  ...
  if($gget == "member" or $gget == "creator" or $gget == "administrator"){
    ...
    if($step == "send" and $cid == $admin){
      ...
      'parse_mode'=>'html',
       'reply_markup'=>json_encode([
            'inline_keyboard'=>[
 [['text'=>"🗣Канал",'url'=>"https://t.me/termux_xacker"]],
  ]
  ])
  ]);
}
